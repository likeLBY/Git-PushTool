...
ApplicationWindow {
    ...
    FolderDialog {
        id: initPushFolderDialog
        title: "选择要初始化的项目文件夹"
        onAccepted: {
            gitManager.repoPath = selectedFolder
            // Wait a bit for repoPath to be set, then open dialog
    ...
    // Init and push dialog - 初始化并推送对话框
    Dialog {
        id: initPushDialog
        title: ""
        anchors.centerIn: parent
        ...
        header: MacTitleBar {
            title: "初始化并关联远程仓库"
            onCloseClicked: initPushDialog.close()
        }
        ...
        contentItem: ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        text: "此功能将自动完成：初始化仓库 → 关联远程仓库\n完成后文件会显示在「已更改文件」列表，你可以自己暂存、提交和推送"
                        font.pixelSize: 12
                        color: "#0369a1"
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        text: "此功能仅用于空项目！如果已有仓库，请使用「克隆仓库」功能"
                        font.pixelSize: 12
                        color: "#92400e"
                        wrapMode: Text.WordWrap
                        Layout.fillWidth: true
            ...
            Rectangle {
                ...
                radius: 8
                color: "#ffffff"
                border.color: initPushUrlInput.activeFocus ? "#3b82f6" : "#e5e7eb"
                border.width: 1
                ...
                TextInput {
                    ...
                    Text {
                        ...
                        font.pixelSize: 13
                        verticalAlignment: Text.AlignVCenter
                        visible: !initPushUrlInput.text && !initPushUrlInput.activeFocus
                    }
                }
            }
            ...
            Rectangle {
                ...
                radius: 8
                color: "#ffffff"
                border.color: initBranchInput.activeFocus ? "#3b82f6" : "#e5e7eb"
                border.width: 1
                ...
                TextInput {
                    ...
                    Text {
                        ...
                        font.pixelSize: 13
                        verticalAlignment: Text.AlignVCenter
                        visible: !initBranchInput.text && !initBranchInput.activeFocus
                    }
                }
            }
            ...
            RowLayout {
                Layout.fillWidth: true
                Layout.topMargin: 8
                Layout.bottomMargin: 16  // 增加底部边距，让按钮完全显示在白色背景内
                spacing: 12
                ...
                Text {
                    text: "取消"
                    font.pixelSize: 13
                    color: cancelArea2.containsMouse ? "#3b82f6" : "#6b7280"
                    Behavior on color { ColorAnimation { duration: 150 } }
                    MouseArea {
                        id: cancelArea2
                        anchors.fill: parent
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            initPushDialog.close()
                            initPushUrlInput.text = ""
                            initBranchInput.text = "main"
                        }
                    }
                }
                ...
                ActionButton {
                    ...
                    fontFamily: fontAwesome.name
                    primary: true
                    enabled: initPushUrlInput.text.trim() !== "" && initBranchInput.text.trim() !== ""
                    onClicked: {
                        gitManager.initAndPushRepo(initPushUrlInput.text, initBranchInput.text)
                        initPushDialog.close()
                        initPushUrlInput.text = ""
                        initBranchInput.text = "main"
                    }
    ...
    // Merge push confirm dialog - 合并推送确认对话框
    Dialog {
        id: mergePushConfirmDialog
        title: ""
        anchors.centerIn: parent
        width: 500
        modal: true
        ...
        header: MacTitleBar {
            title: "合并推送确认"
            onCloseClicked: mergePushConfirmDialog.close()
        }
        ...
        contentItem: ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "• 远程仓库初始化时添加了 README 或 LICENSE\n• 本地仓库是独立初始化的\n• 推送时出现「refusing to merge unrelated histories」错误"
                        font.pixelSize: 12
                        color: "#92400e"
                        Layout.fillWidth: true
                        wrapMode: Text.WordWrap
            ...
            Text {
                text: "此功能会先拉取远程内容并合并不相关的历史，然后推送。\n\n如果你只是正常推送，请点击「取消」，使用普通的「推送」按钮。"
                font.pixelSize: 12
                color: "#6b7280"
                Layout.fillWidth: true
                wrapMode: Text.WordWrap
            ...
            RowLayout {
                ...
                Text {
                    text: "取消"
                    font.pixelSize: 13
                    color: cancelMergePushArea.containsMouse ? "#3b82f6" : "#6b7280"
                    
                    MouseArea {
                        id: cancelMergePushArea
                        anchors.fill: parent
                        anchors.margins: -8
                        hoverEnabled: true
                        cursorShape: Qt.PointingHandCursor
                        onClicked: mergePushConfirmDialog.close()
                    }
                }
                ...
                ActionButton {
                    ...
                    primary: true
                    onClicked: {
                        mergePushConfirmDialog.close()
                        gitManager.pushWithUnrelatedHistories()
                    }
                }
            }
        }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Row {
                    ...
                    // Unlock repository button (only show when needed)
                    IconButton {
                        visible: gitManager.isValidRepo && gitManager.lastError.includes("index.lock")
                        icon: "\uf09c"
                        fontFamily: fontAwesome.name
                        tooltip: "解锁仓库（清除锁定状态）"
                        onClicked: gitManager.unlockRepository()
                    }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                // Init and push button for non-git folders
                Rectangle {
                    Layout.alignment: Qt.AlignHCenter
                    Layout.topMargin: 8
                    width: initPushBtnRow.width + 24
                    height: 36
                    radius: 18
                    color: initPushBtnHover.hovered ? "#3b82f6" : "#eff6ff"
                    border.color: "#3b82f6"
                    border.width: 1
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.family: fontAwesome.name
                            font.pixelSize: 12
                            color: initPushBtnHover.hovered ? "#ffffff" : "#3b82f6"
                            anchors.verticalCenter: parent.verticalCenter
                        }
            ...
            ColumnLayout {
                ...
                Row {
                    ...
                    ActionButton {
                        ...
                        icon: "\uf0c1"
                        fontFamily: fontAwesome.name
                        onClicked: initPushFolderDialog.open()
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ActionButton {
                        ...
                        icon: "\uf0ec"
                        fontFamily: fontAwesome.name
                        onClicked: mergePushConfirmDialog.open()
                        
                        ToolTip.visible: hovered
                        ToolTip.delay: 500
                        ToolTip.text: "合并不相关的历史并推送（用于解决远程仓库初始化冲突）"
                    }
